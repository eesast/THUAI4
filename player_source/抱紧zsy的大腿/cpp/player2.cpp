...
string buffer;
Location scheduled_destination[] = { // player 1 team 0
    Location(4500,4500),
    Location(19500,4500),
    Location(19500, 8500),
    Location(4500, 8500),
    Location(4500, 15500),
    Location(19500, 15500),
    Location(30500, 15500),
    Location(30500, 4500),
    Location(44500, 4500),
    Location(44500, 16500),
    Location(39500, 16500),
    Location(39500, 12500),
    Location(30500, 12500),
    Location(30500, 15500),
    Location(4500, 15500)
};
...
bool find_colorblock(GameApi &g)
{
    ...
    int state[9][9];// 1代表墙，2代表己方颜色，3代表非己方颜色，4代表不可见，5代表出生点
    for (auto k: _wall)
    {
    ...
    {
        cout << "find a empty color block at (" << save_location.first << "," << save_location.second << ") "<< save_count << endl;
        if (self->bulletNum)
        {
